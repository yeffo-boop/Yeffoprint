...
final class YeffoPrint_Core {
	...
	private function includes(): void {
		...
		require_once YEFFOPRINT_CORE_PATH . 'includes/woocommerce/class-shippo-webhook-secret.php';
		require_once YEFFOPRINT_CORE_PATH . 'includes/woocommerce/class-shippo-webhook-sync.php';
		require_once YEFFOPRINT_CORE_PATH . 'includes/rest/class-shippo-webhook-controller.php';
		require_once YEFFOPRINT_CORE_PATH . 'includes/woocommerce/tracking-providers/class-shippo-tracking-provider.php';
		...
		require_once YEFFOPRINT_CORE_PATH . 'includes/woocommerce/class-order-addon-account.php';
		require_once YEFFOPRINT_CORE_PATH . 'includes/woocommerce/class-order-addon-email-notice.php';
		require_once YEFFOPRINT_CORE_PATH . 'includes/rest/class-order-addon-controller.php';
		...
		new YeffoPrint_NOWPayments_Webhook_Controller();
		...
		new YeffoPrint_Order_Addon_Email_Notice();
		new YeffoPrint_Order_Addon_Controller();
		...
		add_filter( 'woocommerce_payment_gateways', static function ( array $gateways ): array {
			...
			require_once YEFFOPRINT_CORE_PATH . 'includes/woocommerce/class-nowpayments-gateway.php';

			$gateways[] = 'YeffoPrint_Venmo_Gateway';
			$gateways[] = 'YeffoPrint_Zelle_Gateway';
			$gateways[] = 'YeffoPrint_NOWPayments_Gateway';
			return $gateways;
		} );
		...
		add_action( 'woocommerce_blocks_payment_method_type_registration', static function ( $registry ): void {
			...
			require_once YEFFOPRINT_CORE_PATH . 'includes/woocommerce/class-nowpayments-blocks-support.php';

			$registry->register( new YeffoPrint_Venmo_Blocks_Support() );
			$registry->register( new YeffoPrint_Zelle_Blocks_Support() );
			$registry->register( new YeffoPrint_NOWPayments_Blocks_Support() );
		} );
