...
class YeffoPrint_Admin_App {
	...
	public function enqueue_assets( string $hook ): void {
		...
		foreach ( [ 'materials', 'sizes', 'sticker-sizes', 'templates', 'label-fields', 'web-design-packages', 'web-design-addons', 'maintenance', 'pricing', 'orders', 'order-history', 'abandoned-carts', 'web-design-orders', 'customers', 'coupons', 'proofs', 'rewards', 'surcharge', 'settings', 'manual-order' ] as $view ) {
			wp_enqueue_script(
