...
class YeffoPrint_Admin_App {
	...
	public function enqueue_assets( string $hook ): void {
		...
		foreach ( [ 'materials', 'sizes', 'sticker-sizes', 'templates', 'field-presets', 'web-design-packages', 'maintenance', 'pricing', 'orders', 'order-history', 'customers', 'coupons', 'proofs', 'rewards', 'surcharge', 'settings', 'manual-order' ] as $view ) {
			wp_enqueue_script(
