...
class YeffoPrint_Admin_Menu {
	...
	public function render_maintenance_section_intro(): void {
		?>
		<p><?php esc_html_e( 'The maintenance/monitoring subscription is sold via a Stripe Payment Link, created directly in your Stripe Dashboard (separate from WooPayments) — paste the webhook signing secret here once it\'s set up. The payment link itself is set on the Maintenance add-on record under Web Design Add-ons, not here.', 'yeffoprint-core' ); ?></p>
		<?php
	}
